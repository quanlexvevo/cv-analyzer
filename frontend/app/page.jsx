...
export default function Home() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      // GA Event: analiz başarıyla tamamlandı
      ...
      // GA Event: analiz başarısız
      event("analysis_failed", { error_message: err.message });
    } finally {
      setLoading(false);
    }
  };
